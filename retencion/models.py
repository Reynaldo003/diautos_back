...
class OrdenServicioVentaDiautos(models.Model):
    ...
    nombre_cte = models.CharField(max_length=255, null=True, blank=True, db_column="Nombre_CTE", db_index=True)
    ...
    email = models.CharField(max_length=255, null=True, blank=True, db_column="Email", db_index=True)
    ...
    numero_serie = models.CharField(max_length=150, null=True, blank=True, db_column="Numero_Serie", db_index=True)
    ...
    fecha_venta = models.DateField(null=True, blank=True, db_column="Fecha_Venta", db_index=True)
    folio_factura = models.CharField(max_length=50, null=True, blank=True, db_column="Folio_Factura", db_index=True)
    ...
    id_os = models.CharField(max_length=50, null=True, blank=True, db_column="ID_OS", db_index=True)
    ...
    def __str__(self):
        return f"OS/Venta {self.id} - {self.folio_factura or 'Sin Factura'}"
...
class DetalleVentasPostVentaLimpia(models.Model):
    ...
    ore_numserie = models.CharField(max_length=100, null=True, blank=True, db_column="ORE_NUMSERIE", db_index=True)
    ore_fechaord = models.DateField(null=True, blank=True, db_column="ORE_FECHAORD", db_index=True)
    ...
    veh_noplacas = models.CharField(max_length=30, null=True, blank=True, db_column="VEH_NOPLACAS", db_index=True)
    ...
    factura = models.CharField(max_length=100, null=True, blank=True, db_column="FACTURA", db_index=True)
    ...
    class Meta:
        ...
        managed = False
        ordering = ["-ore_fechaord"]

    def __str__(self):
        return f"Orden {self.ore_idorden} - {self.ore_numserie or 'Sin VIN'}"
