...
def validar_contrasena_usuario(usuario, contrasena_plana):
    ...
    # ✅ CAMBIADO: usuario.contrasena → usuario.password
    contrasena_guardada = usuario.password or ""
    ...
    if es_valida:
        # ✅ CAMBIADO: usuario.contrasena → usuario.password
        usuario.password = make_password(contrasena_plana)
        # ✅ CAMBIADO: "contrasena" → "password"
